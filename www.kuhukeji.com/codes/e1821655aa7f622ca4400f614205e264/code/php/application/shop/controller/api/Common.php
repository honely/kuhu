...
class Common extends Controller
{
    ...
    public function _initialize()
    {
        ...
        if ($seo = $SettingModel->where(['app_id'=>$this->appId])->value('seo')) {
            //$this->warning('请提醒管理员设置SEO信息！');
            $seo = json_decode($seo) ? json_decode($seo,true) : [];
        }

        $this->default_seo = [
            'title' => $seo['title'] ? $seo['title'] : '我要有电商商城小程序',
            'keywords' => $seo['keywords'] ? $seo['keywords'] : '我要有电商商城小程序',
            'description' => $seo['description'] ? $seo['description'] : '我要有电商商城小程序',
        ];
