<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/www.kuhukeji.com/application/web/view/passport/register.html";i:1558748961;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div id="regbox" class="register-box">
    <div class="n-wrap">
            ...
            <div class="register-form">
                ...
                <div class="reform-item">
                    <div class="m-regForm">
                        ...
                        <input type="text" autocomplete="off" name="code" v-model="code" class="u-input" id="sms"
                               tabindex="2" maxlength="6" placeholder="输入验证码">
                    </div>
                    <div class="m-smsBtn">
                        <button type="button" :class="djsType==0? 'u-btn u-btn-sms  u-btn-disabled' : 'u-btn u-btn-sms'"
                                style="cursor: pointer" @click="getyzm" v-html="djsTxt">
                        </button>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <div class="wrap-input">
                            <input name="password" type="password" v-model="password" autocomplete="off" class="control"
                                   placeholder="8-20位字符，包含数字和字母">
                            <i class="u-icon-clear"></i>
                            <label class="bottom-line"></label>
                        </div>
                    </div>
                ...
                <div class="form-group" style="margin-top: 12px;">
                    <div class="field">
                        <button wyu="submit" id="embed-submit" @click="onsubmit" :loading="loading" type="button"
                                class="u-btn u-btn-submit">立即注册
                        </button>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 24px">
                    <div class="field">
                        ...
                        <div class="login">
                            <a href="/web/passport/login.html" style="color: #0078E0;">已有账号？立即登录</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="copy">
            ICP备案：<?=!empty($siteinfo['icp']) ? $siteinfo['icp'] : '皖ICP备14015149号-4';?> <?=!empty($siteinfo['company']) ? $siteinfo['company'] : '合肥微小宝网络科技有限公司';?> </div>
    </div>
</div>
<style>
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            onsubmit() {
                ...
                this.loading = true;
                $.post('/web/passport/register.html', {
                    mobile: this.mobile,
            ...
            getcode() {
                ...
                $.ajax({
                    url: "<?=url('web/passport/sendSms')?>", // 加随机数防止缓存
                    type: "post",
                    dataType: "json",
                    data: param,
                    success: function (data) {
