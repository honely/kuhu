<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/www/wwwroot/www.kuhukeji.com/application/web/view/index/index.html";i:1556523114;s:67:"/www/wwwroot/www.kuhukeji.com/application/web/view/public/menu.html";i:1554979218;s:69:"/www/wwwroot/www.kuhukeji.com/application/web/view/public/footer.html";i:1558839056;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<section>
  ...
  <div class="topNav">
    ...
    <!-- Swiper JS -->
    <script type="text/javascript" src="/static/web/plugin/swiper/js/swiper.min.js"></script>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide-01" style="background: url(<?=$val['pic'];?>) no-repeat center center;">
                    <a target="_blank" style="width:100%;display: block;height: 100%;" href="<?=$val['link'];?>"></a>  
            </div>
    ...
    <div class="plan-box">
        <div class="n-wrap">
            ...
            <div class="plan-cont">
                <?php $i=0;foreach($apps as $val){ $i++; if($i<=10) {?>
                <div class="item-plan">
    ...
    <div class="visual-box">
        <div class="n-wrap">
            <h1 class="vn-tit">一键拖拽组件化 自由组合</h1>
            <p class="vn-hint">零基础、零代码、傻瓜式操作，分分钟极速生成您的专属小程序</p>
            <div class="vn-cont">
                <div class="v-bg"></div>
                <div class="vnImg01"></div>
                <div class="vnImg02"></div>
                <div class="vnImg03"></div>
            </div>
        </div>
    </div>
