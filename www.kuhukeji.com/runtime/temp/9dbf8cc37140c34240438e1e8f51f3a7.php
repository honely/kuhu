<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/www/wwwroot/www.kuhukeji.com/application/website/view/index/template.html";i:1561087907;s:71:"/www/wwwroot/www.kuhukeji.com/application/website/view/public/menu.html";i:1561087907;s:73:"/www/wwwroot/www.kuhukeji.com/application/website/view/public/footer.html";i:1561087907;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title><?=$siteinfo['sitename'];?>万能建站---<?=$siteinfo['title'];?></title>
    <meta name="Keywords"  content="<?=$siteinfo['sitename'];?>万能建站小程序系统模版、<?=$siteinfo['sitename'];?>万能建站微信小程序模版、<?=$siteinfo['sitename'];?>万能建站支付宝小程序模版、<?=$siteinfo['sitename'];?>万能建站百度小程序" />
                ...
                <ul class="tmp-list">
                    ...
                    <li class="rt-tmp">
                        <div class="type-box">
                            ...
                            <?php if(!empty($cats)){ ?>
                            <span class="item-type <?php if($cat == 0){ ?>active <?php }?>"><a href="/website/index/template.html">全部</a></span>
                            <?php foreach($cats as $val){ ?>
                            <span class="item-type <?php if($cat == $val['cat_id']){ ?>active <?php }?>"><a href="/website/index/template/cat/<?=$val['cat_id'];?>.html"><?=$val['cat_name'];?></a></span>
                              <?php } }?>     
                        </div>
